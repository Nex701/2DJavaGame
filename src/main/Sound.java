...
public class Sound {
	...
	public Sound() {
		...
		soundURL[15] = getClass().getResource("/sound/slimehit.wav");
		soundURL[16] = getClass().getResource("/sound/slimeDeath.wav");
		soundURL[17] = getClass().getResource("/sound/swordSwing1.wav");
	}
